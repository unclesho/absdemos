...
//The funny thing about this is that this activity does not associate with any XML in the res/layout
//folder. This class is the first class to be called when the application is launched as indicated in the 
//manifest.xml.
public class SampleList extends SherlockListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		/* Just get a handle of the intent for manipulation later */
		Intent intent = getIntent();
		/*I don't know what this is for now. 20120910 */
		String path = intent.getStringExtra("com.example.android.apis.Path"); 
		if (path == null) {
			path = "";
		}
		
//		Log.d("SampleList","roslen:" + path);
		
		//this takes the place of "setContentView"..
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		SubMenu sub = menu.addSubMenu("Themes");
